...
def test0():
    ...
    (nsteps,chi) = (100,5)
    for N in xrange(5,6):
        test2(J,muB,N,1./nsteps,nsteps,chi)
...
##        show(hamiltonian[i+1],"hamiltonian[i+1]")
        ...
        energy += operatorInnerOBC(mps,hamiltonian,mps)
    return energy
